...
export default function SignupOptions({
  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between px-6 pb-6 pt-2 select-none antialiased">
      {/* Top Header */}
      <div className="relative flex items-center justify-between w-full pt-4 pb-2">
        ...
        <h2 className="justify-items-center text-[20px] font-bold text-black tracking-tight font-sans">
          Create account
        </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-start mt-6">
        {/* Description */}
        <p className="text-gray-600 text-[14.5px] leading-relaxed text-center font-medium max-w-[310px] px-2 mb-10">
      ...
      {/* Bottom Area: Disclaimer & iPhone Indicator */}
